...
export type GetProfileInfoQuery = { Domains: { Domain: Array<{ tokenAddress: any, tokenId: string | null, avatar: string | null, dappName: DomainDappName | null, dappSlug: DomainDappSlug | null, name: string | null }> | null } | null, Wallet: { addresses: Array<any> | null, primaryDomain: { name: string | null, avatar: string | null, tokenNft: { contentValue: { image: { small: string | null } | null } | null } | null } | null, domains: Array<{ name: string | null, avatar: string | null, tokenNft: { contentValue: { image: { small: string | null } | null } | null } | null }> | null, xmtp: Array<{ isXMTPEnabled: boolean | null }> | null } | null, TokenBalances: { TokenBalance: Array<{ tokenAddress: any, amount: string, formattedAmount: number | null, tokenType: TokenType | null, tokenNfts: { address: any, tokenId: string, blockchain: TokenBlockchain | null, contentValue: { image: { original: string | null } | null } | null } | null }> | null, pageInfo: { nextCursor: string, prevCursor: string, hasNextPage: boolean, hasPrevPage: boolean } | null } | null, farcasterSocials: { Social: Array<{ twitterUserName: string | null, profileUrl: string | null, website: string | null, isDefault: boolean | null, blockchain: Blockchain | null, dappName: SocialDappName | null, profileName: string | null, profileDisplayName: string | null, profileHandle: string | null, profileImage: string | null, profileBio: string | null, followerCount: number | null, followingCount: number | null, profileTokenId: string | null, profileTokenAddress: string | null, profileCreatedAtBlockTimestamp: any | null, profileImageContentValue: { image: { small: string | null } | null } | null, socialCapital: { socialCapitalScore: number | null } | null }> | null } | null, lensSocials: { Social: Array<{ twitterUserName: string | null, profileUrl: string | null, website: string | null, isDefault: boolean | null, blockchain: Blockchain | null, dappName: SocialDappName | null, profileName: string | null, profileDisplayName: string | null, profileHandle: string | null, profileImage: string | null, profileBio: string | null, followerCount: number | null, followingCount: number | null, profileTokenId: string | null, profileTokenAddress: string | null, profileCreatedAtBlockTimestamp: any | null, profileImageContentValue: { image: { small: string | null } | null } | null, socialCapital: { socialCapitalScore: number | null } | null }> | null } | null };

export type GetNfTsQueryVariables = Exact<{
  Identity: InputMaybe<Array<Scalars['Identity']['input']> | Scalars['Identity']['input']>;
}>;


export type GetNfTsQuery = { ethereum: { TokenBalance: Array<{ tokenAddress: any, amount: string, formattedAmount: number | null, tokenType: TokenType | null, token: { isSpam: boolean | null, name: string | null } | null, tokenNfts: { address: any, tokenId: string, blockchain: TokenBlockchain | null, contentValue: { image: { original: string | null } | null } | null } | null }> | null, pageInfo: { nextCursor: string, prevCursor: string, hasNextPage: boolean, hasPrevPage: boolean } | null } | null, base: { TokenBalance: Array<{ tokenAddress: any, amount: string, formattedAmount: number | null, tokenType: TokenType | null, tokenNfts: { address: any, tokenId: string, blockchain: TokenBlockchain | null, contentValue: { image: { original: string | null } | null } | null } | null }> | null, pageInfo: { nextCursor: string, prevCursor: string, hasNextPage: boolean, hasPrevPage: boolean } | null } | null };
